      ...
      <main className="flex-1 overflow-y-auto bg-[#fafafa] p-8 h-full">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-2 text-[13px]">
            ...
            <button className="bg-black text-white px-4 py-1.5 rounded-lg font-medium shadow-sm">Crear un agente</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8 text-[12px]">
          <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex flex-col justify-between h-36 border-t-4 border-t-blue-400">
            <div className="flex justify-between items-center mb-1">
              <span class="font-bold text-sm text-gray-900">Fable 5</span>
              <span class="bg-blue-50 text-blue-600 text-[10px] px-1.5 py-0.5 rounded font-medium border border-blue-100">Nuevo</span>
            </div>
          ...
          <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex flex-col justify-between h-36 border-t-4 border-t-gray-400">
            <div className="flex justify-between items-center mb-1">
              <span className="font-bold text-sm text-gray-900">Sonnet 5</span>
              <span className="bg-blue-50 text-blue-600 text-[10px] px-1.5 py-0.5 rounded font-medium border border-blue-100">Nuevo</span>
            </div>
            <p className="text-gray-400 text-[11px] font-mono leading-tight">maris-core-7b • Equiv. Sonnet 5</p>
          </div>
          <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex flex-col justify-between h-36 border-t-4 border-t-green-400">
            <div><span className="font-bold text-sm text-gray-900">Haiku 4.5</span><p className="text-gray-400 text-[11px] font-mono leading-tight">maris-velox-1b • Equiv. Haiku 4.5</p></div>
          </div>
        </div>
      </main>
    </div>
