 ...
 *
 * Uso (en local o en la consola/shell de Coolify, en la raíz del proyecto):
 *   node init-agents.js
...
function main() {
  ...
  if (!fs.existsSync(DB_PATH)) {
    ...
    console.error('   Ajusta DB_PATH para que apunte al mismo sitio que usa server.js (por defecto /data en Coolify).\n');
    process.exit(1);
  }
