...
// SEGMENTACIÓN COMERCIAL DEL SAAS (modelo de negocio por niveles):
...
const AGENTS = [
  ...
  },
  {
    ...
    // un agente con System Prompt — es código real (lib/vercelDeploy.ts)
    // que llama a la API de Vercel directamente. Se siembra como
    // determinista (sin LLM) para no inventar una persona que no existe
    // en el original.
    tipo: 'deterministic',
    executorType: 'vercel_api',
    systemPrompt: null,
    habilidades: ['Configuración Vercel', 'Despliegue Automatizado', 'Gestión de Variables de Entorno'],
    busquedaWeb: false,
...
// Asistentes estándar de propósito general, sin
